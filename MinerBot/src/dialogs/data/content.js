...
/**
 * Este módulo centraliza todas las respuestas informativas estáticas para MinerBot Global,
 * organizadas temáticamente para facilitar su gestión. Cada clave corresponde a una opción de menú
 * (en minúsculas y sin acentos para coincidir con la lógica de entrada), y su valor es la
 * respuesta detallada que el bot debe proporcionar.
 *
 * Se utiliza un lenguaje formal, claro, conciso y técnico, apropiado para un entorno empresarial minero.
 * Las respuestas incluyen llamadas a la acción e integran referencias a plataformas internas (SharePoint, Intranet).
 *
 * Compañía: MinerBot Global
 * Sedes: Iquique (Faena Minera 'Cerro Brillante'), Santiago (Oficina Corporativa 'Torre Andes'), Canadá (Casa Matriz)
 */
module.exports = {
    // ======================================================================================
    ...
    // ======================================================================================
    // 1. Vacaciones, Licencias y Permisos (ID: 'vacaciones')
    // ======================================================================================
    ...
    // --- Sub-menú: Tipos de Permisos Legales (ID: 'tiposPermisosLegales') ---
    ...
    // ======================================================================================
    // 2. Beneficios Económicos (ID: 'beneficios')
    // ======================================================================================
    ...
    // ======================================================================================
    // 3. Salud y Seguros (ID: 'saludSeguros')
    // ======================================================================================
    ...
    'procedimiento de reembolso médico/dental': 'Para solicitar el reembolso de gastos médicos o dentales no cubiertos por su plan base, debe presentar las facturas o boletas originales junto con el formulario de reembolso completo, dentro de los 30 días posteriores al gasto. Acceda al formulario y la política en el SharePoint de Salud y Bienestar. [Formulario Reembolso](https://minerbot.sharepoint.com/sitios/Salud/reembolsos)',
    ...
    // --- Sub-menú: Tipos de Seguros de Salud (ID: 'tiposSegurosSalud') ---
    ...
    // ======================================================================================
    // 4. Bienestar y Conciliación (ID: 'bienestarConciliacion')
    // ======================================================================================
    ...
    // --- Sub-menú: Programas Internos (ID: 'programasInternos') ---
    ...
    // --- Sub-menú: Apoyo Familiar (ID: 'apoyoFamiliar') ---
    ...
    // ======================================================================================
    // 5. Cultura y Valores (ID: 'culturaValores')
    // ======================================================================================
    ...
    // --- Sub-menú: Procedimiento para Denuncias (ID: 'procedimientoDenuncias') ---
    ...
    // ======================================================================================
    // 7. Consultas Generales y Otros (ID: 'consultasGenerales')
    // ======================================================================================
