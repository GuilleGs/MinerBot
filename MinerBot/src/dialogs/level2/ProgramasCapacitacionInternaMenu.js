...
// Nota: La ruta a content.js es '../../data/content' para diálogos de nivel 2.

/**
 * Diálogo que gestiona el sub-menú de "Programas de Capacitación Interna".
 * Presenta opciones de información sobre los distintos programas de capacitación que ofrece la empresa.
 */
class ProgramasCapacitacionInternaMenu {
    ...
    constructor(bot) {
        this.bot = bot;
        // Define las opciones específicas de este menú de programas de capacitación.
        this.options = [
            'Capacitación DCL (Desarrollo de Competencias de Liderazgo)',
            'Capacitación SSO (Seguridad y Salud Ocupacional)', // Ajustada a una opción real de content.js
    ...
    /**
     * Muestra el menú de "Programas de Capacitación Interna" al usuario, listando todas las opciones disponibles.
