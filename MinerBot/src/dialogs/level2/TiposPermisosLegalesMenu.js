 ...
 * Presenta información detallada sobre las diferentes categorías de permisos legales reconocidos por la empresa.
 */
class TiposPermisosLegalesMenu {
    ...
    constructor(bot) {
        this.bot = bot;
        // Define las opciones específicas de este menú de tipos de permisos legales.
        this.options = [
    ...
    /**
     * Muestra el menú de "Tipos de Permisos Legales" al usuario, listando todas las opciones disponibles.
