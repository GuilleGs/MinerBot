 ...
 * Presenta opciones de información sobre los diferentes tipos de seguros de salud complementarios ofrecidos por la empresa.
 */
class TiposSegurosSaludMenu {
    ...
    constructor(bot) {
        this.bot = bot;
        // Define las opciones específicas de este menú de tipos de seguros de salud.
        this.options = [
            'Seguro Médico',
            'Seguro Dental',
            'Seguro Catastrófico'
    ...
    /**
     * Muestra el menú de "Tipos de Seguros de Salud" al usuario, listando todas las opciones disponibles.
    ...
    async show(context) {
        ...
        let menuText = 'Tipos de Seguros de Salud:\n'; 
