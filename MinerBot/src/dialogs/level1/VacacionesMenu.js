 ...
 * Ofrece opciones relacionadas con la gestión de vacaciones, licencias médicas
 * y permite navegar al sub-menú de "Tipos de Permisos Legales".
 */
class VacacionesMenu {
    ...
    constructor(bot) {
        this.bot = bot;
        // Define las opciones específicas de este menú.
        this.options = [
    ...
    /**
     * Muestra el menú de "Vacaciones y Permisos" al usuario, listando todas las opciones disponibles.
     ...
     * de "Tipos de Permisos Legales" y la acción de "Volver".
     * @param {TurnContext} context - Contexto del turno actual de la conversación.
    ...
    async handleInput(context, text, conversationData, bot) {
        ...
        if (!isNaN(number) && number > 0 && number <= this.options.length + 1) {
            ...
            // Si la opción seleccionada es "Tipos de Permisos Legales", navega a ese sub-menú.
        ...
        // Procesa la entrada si es el texto "Tipos de Permisos Legales".
